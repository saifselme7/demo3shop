...
export default function CheckoutPage() {
  ...
  const paymentReady = Boolean(paymentNumber.trim());
  ...
  return (
    <main className="bg-paper px-5 pb-24 pt-36 text-ink sm:px-8 sm:pb-32 lg:px-12">
      <div className="mx-auto max-w-[1240px]">
        <FadeIn><SectionLabel index="CHECKOUT">كمل طلبك</SectionLabel><h1 className="mt-7 max-w-3xl text-[clamp(2.6rem,6.5vw,6.2rem)] font-bold leading-[0.95] tracking-[-0.05em]">اطلب دلوقتي<br /><span className="text-ink/35">بخطوة واضحة.</span></h1></FadeIn>
        <div className="mt-14 grid gap-12 lg:grid-cols-[1fr_360px] lg:gap-20">
          <FadeIn delay={0.1} y={24}><form onSubmit={handleSubmit} className="space-y-10" noValidate>
            ...
            <Button type="submit" disabled={submitting || loading || (isLive && !paymentReady)} className="w-full justify-center sm:w-auto sm:min-w-[260px]" arrow>{submitting ? 'بنأكد طلبك...' : 'أكد الطلب'}</Button>
          </form></FadeIn>
